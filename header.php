    ...
    <div class="header__content header-fixed-js">
        <div class="container">
            <div class="header__inner">
                <a class="header__logo" href="http://rubilnik-test.space/october/">
                    <img class="header__logo-img" src="assets/img/header/logo.svg" alt="Logo">
                </a>
                <nav class="header__nav header-nav-open-js">
                    <ul class="header__list">
                        <li>
                            <a href="http://rubilnik-test.space/october/#about">
                                О нас
                            </a>
                        </li>
                        <li>
                            <a href="http://rubilnik-test.space/october/#products">
                                Продукция
                            </a>
                        </li>
                        <li>
